...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aadict-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10917&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aadict-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aadict` can be installed with:

```
conda install aadict
```

It is possible to list all of the versions of `aadict` available on your platform with:
